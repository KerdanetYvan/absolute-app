    ...
    <main style={{ flex: 1, padding: "2rem" }}>
      ...
      <ul className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-8">
        {schools.map((school) => (
          <li
            key={school.id}
            className="w-full max-w-sm bg-white dark:bg-[#454141] border border-gray-200 dark:border-[#3CBDD1] rounded-lg shadow-sm flex flex-col mx-auto mb-8 p-4" // Ajout de w-full pour uniformiser la largeur
          >
            ...
            <div className="p-5 flex flex-col flex-1">
              ...
              <div className="mb-2 text-gray-600 dark:text-gray-400 text-sm">{school.adresse}</div>
              <p className="mb-4 font-normal text-gray-700 dark:text-gray-300 flex-1">
                {school.resume}
              </p>
              <div className="flex gap-2 mt-auto">
                <button
                  className="inline-flex items-center px-3 py-2 text-sm font-medium text-gray-900 dark:text-gray-100 bg-[#FEB157] dark:bg-[#3CBDD1] rounded-lg hover:bg-[#e09e3c] dark:hover:bg-[#7fb3bb] transition"
