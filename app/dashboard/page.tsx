...
export default function DashboardPage() {
  return (
    <div className="pl-[220px] flex min-h-screen dark:bg-[#454141]">
      <NavBarDashboard />
      <main className="flex-1 p-4 sm:p-6 md:p-8">
        <h1 className="text-2xl sm:text-3xl font-bold mb-6 sm:mb-8 text-gray-800 dark:text-gray-200 text-center md:text-left">
          Bienvenue sur le Dashboard Admin
        </h1>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 max-w-5xl mx-auto">
          {/* Carte CRUD Utilisateurs */}
          <Link href="/dashboard/users" className="group">
            <div className="rounded-xl shadow-lg p-4 sm:p-6 bg-white dark:bg-[#454141] border border-gray-100 dark:border-[#3CBDD1] hover:shadow-xl transition-shadow cursor-pointer hover:border-[#FFB151] flex flex-col items-center text-center h-full">
              <div className="flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-[#FFB151]/20 dark:bg-[#3CBDD1]/20 mb-3 sm:mb-4">
                <svg
                  className="w-7 h-7 sm:w-8 sm:h-8 text-[#FFB151] dark:text-[#3CBDD1]"
                  fill="none"
                  stroke="currentColor"
                  strokeWidth="2"
                  viewBox="0 0 24 24"
              ...
              <h2 className="text-lg sm:text-xl font-semibold text-gray-800 dark:text-gray-400 mb-1 sm:mb-2">
