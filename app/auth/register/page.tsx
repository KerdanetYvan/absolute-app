...
export default function RegisterPage() {
    return (        <div className="h-screen overflow-hidden bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
            ...
            <div className='absolute bottom-0 left-0 w-full h-[300px] overflow-hidden'>
                <span className='bg-[#FCB259] w-[298px] h-[298px] left-[-50px] bottom-[-150px] rounded-full absolute z-0'></span>
                <span className='w-[247px] h-[247px] bg-[#FCB259]/40 backdrop-blur-md rounded-full absolute z-10 bottom-[-75px] right-[-50px]'>
                </span>
            </div>
        </div>
    );
